...
export class GraphClient {
    ...
    get(team: Team | undefined, timescale: Timescale | undefined, noOfPlayers: number | undefined, asOfWhen: number | undefined, role: Role | undefined): Observable<GraphPlayerDto[]> {
...
export class LeaderboardClient {
    ...
    getLeaderboard(team: Team | undefined, timescale: Timescale | undefined, noOfPlayers: number | undefined, asOfWhen: number | undefined, role: Role | undefined): Observable<LeaderboardDto[]> {
    ...
    getStreaks(): Observable<StreakDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStreaks(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStreaks(<any>response_);
                } catch (e) {
                    return <Observable<StreakDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<StreakDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetStreaks(response: HttpResponseBase): Observable<StreakDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(StreakDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<StreakDto[]>(<any>null);
    }
}
...
export class PairingClient {
    ...
    getSummary(): Observable<PairingSummaryDto[]> {
        let url_ = this.baseUrl + "/api/Pairing";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PairingSummaryDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<PairingSummaryDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetSummary(response: HttpResponseBase): Observable<PairingSummaryDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(PairingSummaryDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<PairingSummaryDto[]>(<any>null);
    }
}
...
export class GameListingDto implements IGameListingDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.resistanceWin = _data["resistanceWin"];
...
export class GamePlayerDetailDto implements IGamePlayerDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.wasResistance = _data["wasResistance"];
...
export class GraphPlayerDto implements IGraphPlayerDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["graphPoints"])) {
                this.graphPoints = [] as any;
                for (let item of _data["graphPoints"])
...
export class GameOverviewDto implements IGameOverviewDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.resistanceWins = _data["resistanceWins"];
            this.totalGames = _data["totalGames"];
        }
    }
...
export class StreakDto implements IStreakDto {
    playerId!: number;
    maxWins!: number;
    maxLosses!: number;
    current!: number;
    currentWinOrLoss!: boolean;

    constructor(data?: IStreakDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.playerId = _data["playerId"];
            this.maxWins = _data["maxWins"];
            this.maxLosses = _data["maxLosses"];
            this.current = _data["current"];
            this.currentWinOrLoss = _data["currentWinOrLoss"];
        }
    }

    static fromJS(data: any): StreakDto {
        data = typeof data === 'object' ? data : {};
        let result = new StreakDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["playerId"] = this.playerId;
        data["maxWins"] = this.maxWins;
        data["maxLosses"] = this.maxLosses;
        data["current"] = this.current;
        data["currentWinOrLoss"] = this.currentWinOrLoss;
        return data; 
    }
}
...
export class PairingSummaryDto implements IPairingSummaryDto {
    ids?: number[] | undefined;
    wins!: number;
    totalGames!: number;

    constructor(data?: IPairingSummaryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PairingSummaryDto {
        data = typeof data === 'object' ? data : {};
        let result = new PairingSummaryDto();
        result.init(data);
        return result;
    }
...
export interface IPairingSummaryDto {
    ids?: number[] | undefined;
    wins: number;
    totalGames: number;
}
